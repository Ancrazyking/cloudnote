...
<div class="row clear_float">
    ...
    <div class="col_3" id='viewNote'>
        <div class="note_title clear_float">
            ...
            <div class="col_li col_left" style='max-width:80%'><h2 class='h2_styles text_over'
                                                                   id='outputNoteTitle'></h2></div>
    ...
    <div class="col_3" id='editNote'>
        <div class="note_title clear_float">
            <div class="col_li col_left" style='width:79%'><input class='input_text' id='inputNoteTitle' type="text"
                                                                  placeholder="此处输入笔记标题"/></div>
