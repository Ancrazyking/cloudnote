        ...
        <div class="bd-login-main">
            ...
            <form class="login-left" action="<%=basePath%>/login/loginnow" method="post" id="login_form">
                ...
                <div class="row text-row">
                    <input name="loginName" id="login_name" placeholder="账号" data-node="loginUser"
                           class="login-username text" type="text">
                </div>
                <div class="row text-row">
                    <input name="password" id="login_password" placeholder="密码" data-node="loginPwd"
                           class="login-password text" type="password">
                </div>
                ...
                <div class="row row-btn">
                    <input name="提交" data-node="loginSubmit" class="login-btn btn" value="" type="submit"
                           onclick="login()">
